...
#ifndef G1PhysicsList_h
#define G1PhysicsList_h 1

#include "globals.hh"
#include "G4VUserPhysicsList.hh"

class G1PhysicsListMessenger;
...
class G1PhysicsList : public G4VUserPhysicsList
{
  public:

    G1PhysicsList();
    virtual ~G1PhysicsList();
  ...
  private:
    ...
    G1PhysicsListMessenger* fMessenger;
