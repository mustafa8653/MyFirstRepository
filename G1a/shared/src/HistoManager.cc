...
{ 
  ...
  // id = 0
  fHisto[0] = new TH1D("EAbs", "Edep in absorber (MeV)", 100, 0., 10*CLHEP::MeV);
  // id = 1
  fHisto[1] = new TH1D("ProcessNumber", "NumberOfProcess", 13, 0.5, 13.5);
  ...
  fNtuple1->Branch("Eabs", &fEdep, "Eabs/D");
  

  // create 2nd ntuple 
  fNtuple2 = new TTree("Ntuple2", "ProcessNumber");
  fNtuple2->Branch("ProcessType", &fIndex, "ProcessType/I");
...
void HistoManager::FillNtuple1(G4double edep)
...
void HistoManager::FillNtuple2(G4double index)
